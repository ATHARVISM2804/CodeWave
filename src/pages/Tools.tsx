...
const tools = [
	{
		...
		description:
			'Intelligent code suggestions and automated refactoring powered by advanced AI models',
		icon: Brain,
	...
	},
	{
		...
		description:
			'Create and deploy AI-powered chatbots for your applications',
		icon: Bot,
		category: 'AI',
		stats: '10K+ Chatbots',
...
const ToolsPage: React.FC = () => {
  ...
  const navigate = useNavigate();
	...
	return (
		<div className="min-h-screen pt-16" style={{ color: 'var(--text-primary)' }}>
			{/* Hero Section */}
			<section className="py-20 md:py-28 relative overflow-hidden">
				{/* Background Elements */}
				<div className="absolute inset-0 pointer-events-none">
					<div
						className="absolute top-20 left-10 w-96 h-96 opacity-15 rounded-full blur-3xl"
						style={{
							background:
					...
					></div>
					<div
						className="absolute bottom-20 right-10 w-96 h-96 opacity-10 rounded-full blur-3xl"
						style={{
							background:
				...
				<div className="absolute inset-0 pointer-events-none overflow-hidden hidden lg:block">
					...
					>
						<div
							className="w-12 h-12 rounded-xl flex items-center justify-center shadow-xl backdrop-blur-sm"
							style={{
					...
					<div
						className="absolute top-48 left-32 animate-float"
						style={{ animationDelay: '1.2s' }}
					>
						<div
							className="w-10 h-10 rounded-lg flex items-center justify-center shadow-xl backdrop-blur-sm"
							style={{
								background: 'var(--card-bg)',
								border: '1px solid var(--card-border)',
					...
					<div
						className="absolute bottom-32 right-48 animate-float"
						style={{ animationDelay: '0.6s' }}
					>
						<div
							className="w-11 h-11 rounded-lg flex items-center justify-center shadow-xl backdrop-blur-sm"
							style={{
								background: 'var(--card-bg)',
								border: '1px solid var(--card-border)',
					...
					<div className="max-w-4xl mx-auto text-center">
						...
						>
							...
							<div className="flex items-center justify-center gap-2 mb-6">
								<span
									className="flex items-center gap-2 px-4 py-2 rounded-full border text-sm shadow-lg"
									style={{
										borderColor: 'var(--accent-primary)',
										background: 'var(--card-bg)',
										boxShadow:
											'0 4px 15px rgba(var(--accent-primary-rgb), 0.15)',
									}}
								>
									<Sparkles
										className="w-3 h-3"
							...
							>
								...
								AI-powered tools designed for the modern developer
							</p>
						</motion.div>
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
						{filteredTools.map((tool, idx) => (
							<div
								key={idx}
								className={`rounded-2xl border shadow-xl backdrop-blur-md transform transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl group relative overflow-hidden ${
							...
							>
								...
								<div
									...
									style={{
										background:
											'radial-gradient(circle at 30% 30%, rgba(var(--accent-primary-rgb), 0.12), transparent 70%)',
									}}
								></div>
								...
								<div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000 overflow-hidden rounded-2xl pointer-events-none">
									<div
										className="absolute -inset-full h-[200%] w-[200%] rotate-45 translate-x-[-100%] group-hover:animate-[enhancedToolGlare_2s_ease_forwards] bg-gradient-to-r from-transparent via-[var(--accent-primary)]/35 to-transparent"
									></div>
								</div>
								...
								<div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000 overflow-hidden rounded-2xl pointer-events-none">
									<div
										className="absolute -inset-full h-[200%] w-[200%] rotate-[135deg] translate-x-[-100%] group-hover:animate-[subtleToolGlare_2.3s_ease_0.4s_forwards] bg-gradient-to-r from-transparent via-white/15 to-transparent"
									></div>
								</div>
								...
								<div className="p-6 relative z-10">
									<div className="flex items-center gap-4 mb-6">
										<div
											className={`w-16 h-16 bg-gradient-to-r ${tool.gradient} rounded-xl flex items-center justify-center magnetic-effect`}
										>
											<tool.icon className="w-8 h-8 text-white" />
										</div>
										<div>
											<h3
												className="text-xl font-bold group-hover:text-[var(--accent-primary)] transition-colors duration-300"
									...
									>
										<span
											className="text-sm font-medium bg-gradient-to-r from-[var(--accent-primary)] to-[var(--accent-secondary)] bg-clip-text text-transparent"
										>
											{tool.stats}
										</span>
										<button
			...
			<section className="py-16 md:py-24 relative">
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div
						className="rounded-2xl p-10 border shadow-2xl backdrop-blur-md transform transition-all duration-500 hover:scale-[1.02] hover:shadow-3xl group relative overflow-hidden text-center"
						style={{
							background: 'var(--card-bg)',
							border: '1px solid var(--card-border)',
							color: 'var(--text-primary)',
					...
					>
						...
						<div
							...
							style={{
								background:
									'radial-gradient(circle at 50% 50%, rgba(var(--accent-primary-rgb), 0.1), transparent 70%)',
							}}
						></div>
						...
						<div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000 overflow-hidden rounded-2xl pointer-events-none">
							<div
								className="absolute -inset-full h-[200%] w-[200%] rotate-45 translate-x-[-100%] group-hover:animate-[ctaToolEnhancedGlare_2.2s_ease_forwards] bg-gradient-to-r from-transparent via-[var(--accent-primary)]/40 to-transparent"
							></div>
						</div>

						{/* Second glare effect */}
						<div
							className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000 overflow-hidden rounded-2xl pointer-events-none"
							style={{ animationDelay: '0.3s' }}
						>
							<div
								className="absolute -inset-full h-[200%] w-[200%] rotate-[225deg] translate-y-[-100%] group-hover:animate-[secondaryToolGlare_2s_ease_0.6s_forwards] bg-gradient-to-r from-transparent via-[var(--accent-primary)]/20 to-transparent"
							></div>
						</div>
						...
						<div className="relative z-10">
							...
							<p
								...
								style={{ color: 'var(--text-secondary)' }}
							>
								We can build specialized tools tailored to your specific workflow
								and requirements. Let's create a solution that perfectly fits your
								development needs.
							</p>
