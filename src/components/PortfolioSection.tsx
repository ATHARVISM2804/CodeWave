  ...
  return (
    <section ref={sectionRef} className="py-20 md:py-28 relative z-1">
      ...
      <div className="container mx-auto px-4 sm:px-8 lg:px-16 relative z-10">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12 mt-12">
            {projects.map((project, index) => (
              ...
              >
                <div className="rounded-3xl p-6 shadow-lg transition-all duration-700 relative overflow-hidden backdrop-blur-sm"
                ...
                >
                  <div className="relative z-10">
                    ...
                    <div className="space-y-3">
                      ...
                      {/* <div className="flex items-center gap-2 pt-2 opacity-100 transition-none transform-none">
                        <button className="flex items-center gap-1 text-sm font-semibold relative overflow-hidden"
        ...
        >
          <div className="rounded-3xl p-8 transition-all duration-500 relative overflow-hidden backdrop-blur-sm"
            style={{ background: 'var(--card-bg)' }}
          >
            <div className="relative z-10">
              <h3 className="text-2xl font-bold mb-4 transition-all duration-300" style={{ color: 'var(--text-primary)' }}>
